...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        $$
        \forall g \in C^{0}(\mathds{R}) \textnormal{, if } \seq \overset{p}{\rightarrow}  \Rightarrow g(\seq) \overset{p}{\rightarrow} g(\X)
        $$\\
        ...
        $$
        d(\X_a,\X_b) = \inf \{\epsilon \in \mathds{R}_+: \mathds{P}(|\X_a-\X_b|>\epsilon) \geq \epsilon\},
        $$
