...
\underline{\textbf{Student's $t$-distribution and CI for normal means}}: \\
...
This is so since the quantity $V = (n-1) \frac{S_{n-1}}{\sigma^2} \sim \chi^2_{n-1}$ by Cochran's theorem. It is readily shown that 
