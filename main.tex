...
The likelihood function is $p^1(1-p)^9$ in either case, should the coin be a geometric or a Bernoulli trial. As far as the likelihood is concerned, there are 10 trials and only one head. The intention of the flipper is utterly irrelevant.
