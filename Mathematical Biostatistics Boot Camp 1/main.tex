...
\begin{tcolorbox}[title=Question 7]
Let distribution 1 be $N(\mu_1, \sigma_1^2)$N and distribution 2 be $N(\mu_2,\sigma_2^2)$. Let $x_{1,\alpha}$ and $x_{2,\alpha}$x  be the $\alpha^{th}$ quantile from the two distributions, respectively. How are the two mathematically related?
\end{tcolorbox}
